(module
 ...
 (data (i32.const 176) "transfer memo needs two arguments separated by \';\'\00")
 (data (i32.const 240) "kingdom arguments failed the size requirements\00")
 (data (i32.const 288) "kingofeos\00")
 ...
 (data (i32.const 512) "Withdraw from TradEOS\00")
 ...
 (data (i32.const 736) "max coronation time not reached yet\00")
 (data (i32.const 784) "already initialized\00")
 (data (i32.const 9200) "malloc_from_freed was designed to only be called after _heap was completely allocated\00")
 (data (i32.const 9296) "\00\00\00\00\00\00\f0?\00\00\00\00\00\00\f8?")
 (data (i32.const 9312) "\00\00\00\00\00\00\00\00\06\d0\cfC\eb\fdL>")
 (data (i32.const 9328) "\00\00\00\00\00\00\00\00\00\00\00@\03\b8\e2?")
