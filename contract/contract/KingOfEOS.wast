(module
 ...
 (data (i32.const 400) "You were dethroned! Here\'s your profit. - King of EOS\00")
 (data (i32.const 464) "end\00")
 (data (i32.const 480) "must pay with EOS token\00")
 (data (i32.const 512) "no previous claim exists\00")
 (data (i32.const 544) "wrong claim price \00")
 ...
 (data (i32.const 768) "max coronation time not reached yet\00")
 (data (i32.const 816) "already initialized\00")
 (data (i32.const 9232) "malloc_from_freed was designed to only be called after _heap was completely allocated\00")
 (data (i32.const 9328) "\00\00\00\00\00\00\f0?\00\00\00\00\00\00\f8?")
 (data (i32.const 9344) "\00\00\00\00\00\00\00\00\06\d0\cfC\eb\fdL>")
 (data (i32.const 9360) "\00\00\00\00\00\00\00\00\00\00\00@\03\b8\e2?")
 ...
 (func $_ZN9kingofeos10onTransferERKN5eosio8currency8transferE (param $0 i32) (param $1 i32)
  ...
  (block $label$0
   (block $label$1
    ...
    (call $_ZZN5eosio11multi_indexILy4921565091335241728EN9kingofeos12claim_recordEJEE7emplaceIZNS1_10onTransferERKNS_8currency8transferEE3$_0EENS3_14const_iteratorEyOT_ENKUlRSB_E_clINS3_4itemEEEDaSD_
     (i32.add
      (get_local $17)
      (i32.const 16)
     )
    ...
    (call $_ZNSt3__16vectorIN5eosio6actionENS_9allocatorIS2_EEE24__emplace_back_slow_pathIJNS1_16permission_levelERyyRN9kingofeos3endEEEEvDpOT_
     (get_local $7)
     (i32.add
      (get_local $17)
      (i32.const 80)
 ...
 (func $_ZZN5eosio11multi_indexILy4921565091335241728EN9kingofeos12claim_recordEJEE7emplaceIZNS1_10onTransferERKNS_8currency8transferEE3$_0EENS3_14const_iteratorEyOT_ENKUlRSB_E_clINS3_4itemEEEDaSD_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i64)
  (local $5 i32)
 ...
 (func $_ZNSt3__16vectorIN5eosio6actionENS_9allocatorIS2_EEE24__emplace_back_slow_pathIJNS1_16permission_levelERyyRN9kingofeos3endEEEEvDpOT_ (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  (local $8 i32)
 ...
 (func $_ZN9kingofeos3endEv (type $FUNCSIG$vi) (param $0 i32)
  ...
  (call $_ZZN5eosio11multi_indexILy4921565091335241728EN9kingofeos12claim_recordEJEE7emplaceIZNS1_3endEvE3$_1EENS3_14const_iteratorEyOT_ENKUlRS7_E_clINS3_4itemEEEDaS9_
   (i32.add
    (get_local $6)
    (i32.const 32)
   )
 ...
 (func $_ZZN5eosio11multi_indexILy4921565091335241728EN9kingofeos12claim_recordEJEE7emplaceIZNS1_3endEvE3$_1EENS3_14const_iteratorEyOT_ENKUlRS7_E_clINS3_4itemEEEDaS9_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
 ...
 (func $_ZN9kingofeos4initEy (type $FUNCSIG$vij) (param $0 i32) (param $1 i64)
  ...
  (call $_ZZN5eosio11multi_indexILy4921565091335241728EN9kingofeos12claim_recordEJEE7emplaceIZNS1_4initEyE3$_2EENS3_14const_iteratorEyOT_ENKUlRS7_E_clINS3_4itemEEEDaS9_
   (i32.add
    (get_local $7)
    (i32.const 16)
   )
 ...
 (func $_ZZN5eosio11multi_indexILy4921565091335241728EN9kingofeos12claim_recordEJEE7emplaceIZNS1_4initEyE3$_2EENS3_14const_iteratorEyOT_ENKUlRS7_E_clINS3_4itemEEEDaS9_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
