(module
 ...
 (data (i32.const 16) "must pay with EOS token\00")
 (data (i32.const 48) "no previous claim exists\00")
 (data (i32.const 80) "wrong claim price \00")
 (data (i32.const 100) "\04\00\00\00\05\00\00\00")
 ...
 (data (i32.const 224) "kingofeos\00")
 ...
 (data (i32.const 448) "Withdraw from TradEOS\00")
 (data (i32.const 480) "write\00")
 (data (i32.const 496) "T = \00")
 (data (i32.const 512) "static const char *boost::detail::ctti<boost::algorithm::detail::token_finderF<(lambda at contract/KingOfEOS.cpp:60:42)> >::n() [T = boost::algorithm::detail::token_finderF<(lambda at contract/KingOfEOS.cpp:60:42)>]\00")
 ...
 (data (i32.const 912) "max coronation time not reached yet\00")
