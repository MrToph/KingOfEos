(module
 ...
 (table 4 4 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN9kingofeos3endEv $_ZN5boost6detail8function15functor_managerINS_9algorithm6detail13token_finderFIZN9kingofeos10onTransferERKN5eosio16generic_currencyINS7_5tokenILy6138663577826885632ELy1397703940EyEEE13transfer_memoEEUlcE_EEE6manageERKNS1_15function_bufferERSI_NS1_30functor_manager_operation_typeE $_ZN5boost6detail8function21function_obj_invoker2INS_9algorithm6detail13token_finderFIZN9kingofeos10onTransferERKN5eosio16generic_currencyINS7_5tokenILy6138663577826885632ELy1397703940EyEEE13transfer_memoEEUlcE_EENS_14iterator_rangeINSt3__111__wrap_iterIPKcEEEESM_SM_E6invokeERNS1_15function_bufferESM_SM_)
 (memory $0 1)
 (data (i32.const 4) "\00f\00\00")
 (data (i32.const 16) "kingofeos\00")
 (data (i32.const 32) "void init()\00")
 (data (i32.const 48) "Initializing King of EOS!\n\00")
 (data (i32.const 80) "cannot create objects in table of another contract\00")
 (data (i32.const 144) "write\00")
 (data (i32.const 160) "in emplace\00")
 (data (i32.const 176) "KING OF EOS APPLY: \00")
 (data (i32.const 208) "eosio.token\00")
 (data (i32.const 224) "transfer\00")
 (data (i32.const 240) "KING OF EOS END END END\00")
 (data (i32.const 272) "no previous claim exists\00")
 (data (i32.const 304) "max coronation time not reached yet\00")
 (data (i32.const 352) "KingdomKingIndex:\00")
 ...
 (data (i32.const 560) "TEST TEST TEST TEST TEST TEST TEST: \00")
 (data (i32.const 608) "must pay with EOS token\00")
 (data (i32.const 640) "Price:\00")
 (data (i32.const 656) "Claim Price: \00")
 (data (i32.const 672) "transfer memo needs three arguments separated by \';\'\00")
 (data (i32.const 736) "memo arguments must be less than 255 characters\00")
 (data (i32.const 784) "Memo \00")
 (data (i32.const 800) "kingdomKingIndex\00")
 (data (i32.const 820) "\02\00\00\00\03\00\00\00")
 (data (i32.const 832) "T = \00")
 (data (i32.const 848) "static const char *boost::detail::ctti<boost::algorithm::detail::token_finderF<(lambda at KingOfEOS.cpp:115:46)> >::n() [T = boost::algorithm::detail::token_finderF<(lambda at KingOfEOS.cpp:115:46)>]\00")
 (data (i32.const 1056) "magnitude of asset amount must be less than 2^62\00")
 (data (i32.const 1120) "invalid symbol name\00")
 (data (i32.const 1152) "unexpected asset type\00")
 (data (i32.const 1184) "\00\00\00\00\00\00\f0?\00\00\00\00\00\00\f8?")
 (data (i32.const 1200) "\00\00\00\00\00\00\00\00\06\d0\cfC\eb\fdL>")
 (data (i32.const 1216) "\00\00\00\00\00\00\00\00\00\00\00@\03\b8\e2?")
 ...
 (func $init
  ...
  (call $_ZN5eosio11multi_indexILy4921565091335241728EN9kingofeos12claim_recordEJEE7emplaceIZNS1_4initEvEUlRS2_E_EENS3_14const_iteratorEyOT_
   (i32.add
    (get_local $6)
    (i32.const 48)
   )
  ...
  (drop
   (call $_ZNSt3__113__vector_baseIN5eosio11multi_indexILy4921565091335241728EN9kingofeos12claim_recordEJEE8item_ptrENS_9allocatorIS6_EEED2Ev
    (i32.add
     (get_local $6)
     (i32.const 32)
    )
 ...
 (func $_ZN5eosio11multi_indexILy4921565091335241728EN9kingofeos12claim_recordEJEE7emplaceIZNS1_4initEvEUlRS2_E_EENS3_14const_iteratorEyOT_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  ...
  (call $_ZZN5eosio11multi_indexILy4921565091335241728EN9kingofeos12claim_recordEJEE7emplaceIZNS1_4initEvEUlRS2_E_EENS3_14const_iteratorEyOT_ENKUlRS8_E_clINS3_4itemEEEDaSA_
   (i32.add
    (get_local $7)
    (i32.const 16)
   )
 ...
 (func $_ZNSt3__113__vector_baseIN5eosio11multi_indexILy4921565091335241728EN9kingofeos12claim_recordEJEE8item_ptrENS_9allocatorIS6_EEED2Ev (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (block $label$0
 ...
 (func $_ZZN5eosio11multi_indexILy4921565091335241728EN9kingofeos12claim_recordEJEE7emplaceIZNS1_4initEvEUlRS2_E_EENS3_14const_iteratorEyOT_ENKUlRS8_E_clINS3_4itemEEEDaSA_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i64)
  (local $5 i32)
  ...
  (call $_ZZN9kingofeos4initEvENKUlRNS_12claim_recordEE_clES1_
   (i32.load offset=4
    (get_local $0)
   )
   (get_local $1)
  ...
  (drop
   (call $_ZlsIN5eosio10datastreamIjEEERT_S4_RKN9kingofeos5claimE
    (get_local $6)
    (i32.add
     (get_local $1)
     (i32.const 16)
 ...
 (func $_ZNSt3__16vectorIN5eosio11multi_indexILy4921565091335241728EN9kingofeos12claim_recordEJEE8item_ptrENS_9allocatorIS6_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINS5_4itemENS_14default_deleteISC_EEEERyRlEEEvDpOT_ (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  ...
  (drop
   (call $_ZNSt3__114__split_bufferIN5eosio11multi_indexILy4921565091335241728EN9kingofeos12claim_recordEJEE8item_ptrERNS_9allocatorIS6_EEED2Ev
    (i32.add
     (get_local $10)
     (i32.const 8)
    )
 ...
 (func $_ZNSt3__114__split_bufferIN5eosio11multi_indexILy4921565091335241728EN9kingofeos12claim_recordEJEE8item_ptrERNS_9allocatorIS6_EEED2Ev (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $_ZZN9kingofeos4initEvENKUlRNS_12claim_recordEE_clES1_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i64)
  (local $5 i64)
 ...
 (func $_ZlsIN5eosio10datastreamIjEEERT_S4_RKN9kingofeos5claimE (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (i32.store
